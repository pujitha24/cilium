...
you may perform the following steps to troubleshoot ClusterMesh issues.
 ...
 #. For TLS-related manual checks, see TLS Certificate Troubleshooting below.
...
instructions to help diagnose the problem. First, refer to Automatic
Verification above and run the troubleshoot commands. They validate TLS
authentication and display certificate information in a human-readable format.
...
.. tabs::
   ...
   .. group-tab:: cert-manager
      ...
      .. tabs::
         ...
         .. tab:: Install CRDs first
            ...
            Then install cert-manager, configure an issuer, and enable Cluster
            Mesh.
         ...
         .. tab:: Host network webhook
            ...
            Then configure an issuer and enable Cluster Mesh.
   ...
   .. group-tab:: Custom Per-Pod Certificates
      ...
      **TLS handshake failures:**
      ...
      If components start but fail to connect over TLS, check the component
      logs for TLS errors:
